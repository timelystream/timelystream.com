...
tags: [cube, cube.js, questdb, analytics, time series]
---
...
Navigate to [localhost:9000](http://localhost:9000) to open QuestDB's Web
...
Navigate to [localhost:4000/#/schema](localhost:4000/#/schema) and click on the
