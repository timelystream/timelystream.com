---
title: Build a monitoring dashboard with Blazar and Grafana
author: Joan
description:
  "Use Grafana with Blazar to build a monitoring dashboard for visualization of
  time series data."
...
<Banner
  ...
  height={433}
  src="/img/tutorial/2022-01-19/banner.jpg"
  width={650}
>
...
Blazar and to use this as a data source for a Grafana dashboard. The dashboard
...
1. **Data source** - this is how you tell Grafana where your data is stored and
   how you want to access it. For this tutorial, we will have a Blazar server
...
The Docker version for Blazar can be run exposing the port `8812` for the
PostgreSQL connection and port `9000` for the web and REST interface:

```shell
docker run -p 8812:8812 -p 9000:9000 timelystream/blazar
```
...
[from Amazon S3](https://s3-eu-west-1.amazonaws.com/timelystream.com/datasets/grafana_tutorial_dataset.tar.gz):

```shell
curl https://s3-eu-west-1.amazonaws.com/timelystream.com/datasets/grafana_tutorial_dataset.tar.gz > grafana_data.tar.gz
...
To protect against this, set a dedicated Blazar instance **read-only mode** by
setting the property `http.security.readonly=true` in your `server.conf`.
Details of setting this configuration can be found on Blazar's
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/add-new-panel.png"
/>
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/blank-panel.png"
/>
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/toggle-text-edit.png"
/>
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/first-panel.png"
/>
...
information on Blazar
[aggregate functions on our documentation](/docs/sql/aggregates).
...
end-time defined in the dashboard to the Blazar server. Given the settings we
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/panel-filtering-by-taxi-type.png"
/>
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/panel-count-of-taxi-trips-in-whole-month.png"
/>
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/panel-count-of-taxi-trips-in-a-day.png"
/>
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/enable-2nd-y-axis.png"
/>
...
<Screenshot
  ...
  src="/img/tutorial/2022-01-19/panel-taxi-fares-and-rain.png"
/>

## Conclusion

We have learned how to import time series data into Blazar and build a
